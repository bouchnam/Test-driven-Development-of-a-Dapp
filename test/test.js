  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      assert.notEqual(result, '0x0000000000000000000000000000000000000000', "the winner should not be the default address")
      /**********
      ...
      ***********/
      return auctionInstance.winners(itemId=2, {from: accounts[0]})
    }).then(function(result) {
      /**********
